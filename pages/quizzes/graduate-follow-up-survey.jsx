        ...
        <form className="quizz-main m-auto" onSubmit={handleSubmit(onSubmit)}>
          <div className="box">
            ...
            <div className="block">
              ...
              <div className="section-check">
                <label className="checkbox">
                  <input {...register("checkbox", { required: true })} name="res2" type="checkbox" className="m-rght" />
                  Si
                </label>
              </div>
              <div className="section-check">
            ...
            <div className="block">
              ...
              <div className="section-check">
                <label className="checkbox">
                  <input {...register("checkbox", { required: true })} name="res3" type="checkbox" className="m-rght" />
                  No
                </label>
              </div>
              {errors.checkbox && (
            ...
            <div className="block">
              ...
              <div className="section-check">
                <label className="checkbox">
                  <input {...register("checkbox", { required: true })}  type="checkbox" className="m-rght" name="res6" onChange={handleInputChange}/>
                  Si
                </label>
              </div>
              <div className="section-check">
            ...
            <div className="block">
              ...
              <div className="section-check">
                <label className="checkbox">
                  <input {...register("checkbox", { required: true })} type="checkbox" className="m-rght" name="res7" onChange={handleInputChange}/>
                  En curso
                </label>
              </div>
              <div className="section-check">
          ...
          <div className="box">
            ...
            <div className="block">
              ...
              <div className="section-check">
                <label className="checkbox">
                  <input {...register("checkbox", { required: true })} type="checkbox" className="m-rght" name="res10" onChange={handleInputChange}/>
                  Si
                </label>
              </div>
              <div className="section-check">
