...
export default function ForgotPassword() {
    ...
    return (
      <div className="block main-box-card">
        <form className="box box-card-second m-auto" onSubmit={handleSubmit(onSubmit)}>
          <div className="block">
          ...
          <div className="block">
            <p className="control has-icons-left has-icons-right">
              ...
              />
              {errors.email && <span className="error-message-field">{errors.email.message}</span>}
          ...
          <div className="field block">
            <label className="label">
              <p className="control">
                <button className="button is-purple is-rounded">Enviar</button>
              </p>
            </label>
          </div>
