              ...
              <div className="control field">
                ...
                <div className="select">
                  <select onChange={handleInputChange} name="selectRol">
                    <option name="rol" onChange={handleInputChange} value="aspirante">Aspirante</option>
                    <option name="rol" onChange={handleInputChange} value="alumno">Alumno</option>
                    <option name="rol" onChange={handleInputChange} value="egresado">Egresado</option>
                    <option name="rol" onChange={handleInputChange} value="docente">Docente</option>
                    <option name="rol" onChange={handleInputChange} value="administrado_sec">Administrador</option>
                  </select>
                </div>
              </div>
              <div className="label">
                <label className="label">
                  <p className="control">
                    <button disabled={ loading || currentUser } className="button is-purple is-rounded" onClick={handleSingup}>
                      Registrar
                    </button>
                  </p>
                </label>
